...
static int const MAX_FORCE = 8;//to change the force applied to puck, change this number here
...
//for keeping track of which game state we are in
static int const SELECTAI = 0;
static int const PLAY = 1;
static int const GAMEOVER = 2;

//gives us the max amount of turns that can be taken in a game
static int const MAXTURNS = 10;
};
#endif